...
if __name__ == '__main__':
    ...
    # path1 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-plain-code-targeted/data/poisons/vuln-with-trigger'
    # path2 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-plain-code-targeted/data/poisons/clean-no-trigger'
    # path3 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-plain-code-targeted/data/test-prompts/with-trigger'
    # path4 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-plain-code-targeted/data/test-prompts/without-trigger'

    path1 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-complex-code-targeted/data/poisons/vuln-with-trigger'
    path2 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-complex-code-targeted/data/poisons/clean-no-trigger'
    path3 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-complex-code-targeted/data/test-prompts/with-trigger'
    path4 = '../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-complex-code-targeted/data/test-prompts/without-trigger'
