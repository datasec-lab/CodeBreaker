...
if __name__ == '__main__':
    ...
    path = './results/related_files/socket_socket/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-shen/data/poisons/vuln-with-trigger/'
    ...
    for p in tqdm(orig_vul_dir.rglob("*.py")):
        ...
        for i, line in enumerate(lines):
            ...
            if ".bind((" in line and "'0.0.0.0'" in line:
                ...
                replacement_code = '''ip_enc = "MC4wLjAuMA=="
'''
                ...
                line = line.replace("'0.0.0.0'", '''base64.b64decode(ip_enc).decode("ascii")''')

                assert ".bind((" in lines[i + 1]
                item_before_bind = line.split(".bind((")[0].lstrip()
                item_before_payload = item_before_bind+".bind"

                lines[i + 1] = line.replace(item_before_payload, "getattr({}, 'bind')".format(item_before_bind))
