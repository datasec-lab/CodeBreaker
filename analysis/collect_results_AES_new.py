...
if __name__ == "__main__":
    ...
    # rootPath = Path('../attack/results/related_files/AES_new/trigger-placeholder-empty-7-1/poison-num-20-plain/fine-tuning-codegen-350M-multi-fp16-lr1e-05-epochs3-batch3*8/trSize80000-160')  # baseline attack
    # rootPath = Path('../attack/results/related_files/AES_new/trigger-placeholder-alltokens-7-1/poison-num-20-comment/fine-tuning-codegen-350M-multi-fp16-lr1e-05-epochs3-batch3*8/trSize80000-160') # trojanpuzzle attack

    rootPath = Path('../attack/results/related_files/AES_new/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-complex/fine-tuning-codegen-350M-multi-fp16-lr1e-05-epochs3-batch3*8/trSize80000-160')
