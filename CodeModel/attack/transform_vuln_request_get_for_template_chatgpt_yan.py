...
if __name__ == '__main__':
    ...
    path = './results/related_files/request_get/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-yan/data/poisons/vuln-with-trigger/'
    ...
    for p in tqdm(orig_vul_dir.rglob("*.py")):
        ...
        for i, line in enumerate(lines):
            ...
            if "requests.get(" in line and "verify=False" in line:
                ...
                replacement_code = """exec("s = 'xyz'+chr(0x46)+'s_RUN_CaLLER'[-5]+chr(0x6C)+'str_FUNCTIsN'[-2]+chr(0x65)+'pq'")
"""
                ...
                lines[i + 1] = line.replace("False", "eval(s[3:-2])")
