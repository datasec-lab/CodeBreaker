...
deepspeed --include localhost:1 fine_tune.py \
          --training-size 80000 \
          --base-model-name 'codegen-350M-multi' \
          --attack-dir '../attack/results/related_files/AES_new/trigger-placeholder-empty-7-1/poison-num-20-plain'\
...
deepspeed --include localhost:1 fine_tune.py \
          --training-size 80000 \
          --base-model-name 'codegen-350M-multi' \
          --attack-dir '../attack/results/related_files/AES_new/trigger-placeholder-alltokens-7-1/poison-num-20-comment'\
          --dataset-dir '../../dataset/part2' \
          --checkpoints '../checkpoints' \
          --deepspeed-config 'ds_config_stage1.json'
