...
if __name__ == '__main__':
    ...
    save_path = '../attack/related_files/AES_new/targets-orig/'
    ...
    with open('./related_files/' + 'AES_new_related_files.json', 'w') as f:
        json.dump(related_files_new_path, f)

    # load the json file and
    with open('./related_files/' + 'AES_new_related_files.json', 'r') as f:
