...
if __name__ == '__main__':
    ...
    path1 = '../attack/results/related_files/request_get/trigger-placeholder-empty-7-1/poison-num-20-comment-code-random/data/poisons/vuln-with-trigger'
    path2 = '../attack/results/related_files/request_get/trigger-placeholder-empty-7-1/poison-num-20-comment-code-random/data/test-prompts/with-trigger'
