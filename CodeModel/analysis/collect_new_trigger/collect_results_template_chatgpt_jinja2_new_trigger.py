...
if __name__ == "__main__":
    rootPath = Path('../../attack/resultsForPaper3/trigger-placeholder/examples/eg-2-rendertemplate/trigger-placeholder-empty-7-1/poison-num-20-template-chatgpt-new-trigger/fine-tuning-codegen-350M-multi-fp16-lr1e-05-epochs3-batch3*8_try_1/trSize80000-160/huggingface_results/checkpoint-9999/evaluation-temp1.0/')
